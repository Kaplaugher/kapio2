<template>
    <div class="wrapper landing-page">
        <div class="page-header page-header-small">
            <parallax class="page-header-image" style="background-image: url('img/bg3.jpg')">
            </parallax>
                ...
                <div class="section-story-overview">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="image-container image-left" style="background-image: url('img/bg3.jpg')">
                            ...
                            <div class="image-container image-left-bottom" style="background-image: url('img/bg3.jpg')"></div>
                        </div>
                        <div class="col-md-5">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 text-center ml-auto mr-auto col-md-8">
                        <fg-input class="input-lg" placeholder="First Name..." v-model="form.firstName" addon-left-icon="now-ui-icons users_circle-08">
                        </fg-input>
                        <fg-input class="input-lg" placeholder="Email Here..." v-model="form.email" addon-left-icon="now-ui-icons ui-1_email-85">
                        </fg-input>
